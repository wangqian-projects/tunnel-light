...
rightBar.innerHTML=(this.pageIndex+1); 
/*共几页*/
var pageCount=document.getElementById("pageCount");
pageCount.innerHTML="共"+this.pageCount+"页";
var pageCount=document.getElementById("pageCount_1");
pageCount.innerHTML="共"+this.pageCount+"页";
var rowCount =document.getElementById("rowCount");
rowCount.innerHTML="共有"+this.rowCount+"条记录";
var isOK="Y"; 
var cssColor=""; 
