...
angular.module('tm.pagination', []).directive('tmPagination',[function(){
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            if(conf.pagesLength) {
                // 判断一下分页长度
                conf.pagesLength = parseInt(scope.conf.pagesLength, 10);
            ...
            function getPagination(newValue, oldValue) {
                ...
                conf.totalItems=sessionStorage.getItem("totalItems")

                // conf.currentPage
                if(conf.currentPage) {
                    conf.currentPage = parseInt(conf.currentPage, 10);
                }
                if(!conf.currentPage) {
                    conf.currentPage = 1;
                }
