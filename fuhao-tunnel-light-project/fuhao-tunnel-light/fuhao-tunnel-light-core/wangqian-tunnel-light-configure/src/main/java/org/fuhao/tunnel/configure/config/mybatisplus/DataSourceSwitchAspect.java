package org.fuhao.tunnel-light.configure.config.mybatisplus;
...
import org.fuhao.tunnel-light.configure.annotaition.DB;
import org.fuhao.tunnel-light.configure.enums.DBTypeEnum;
...
public class DataSourceSwitchAspect {
    ...
    @Pointcut("execution(* org.fuhao.*.*.dao..*.*(..))")
